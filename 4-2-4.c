...
int main() {
    ...
    printf("6. struct cat: sizeof=%zu, alignof=%zu\n", sizeof(struct cat), _Alignof(struct cat));
    printf("7. struct dog: sizeof=%zu, alignof=%zu\n", sizeof(struct dog), _Alignof(struct dog));
    printf("8. struct mouse: sizeof=%zu, alignof=%zu\n", sizeof(struct mouse), _Alignof(struct mouse));
    printf("9. struct rat: sizeof=%zu, alignof=%zu\n", sizeof(struct rat), _Alignof(struct rat));
    printf("10. struct fox: sizeof=%zu, alignof=%zu\n", sizeof(struct fox), _Alignof(struct fox));
    return 0;
}
